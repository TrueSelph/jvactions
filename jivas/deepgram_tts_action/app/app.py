"""
This module provides the main application logic for rendering Deepgram TTS actions.

It uses Streamlit to display the UI and integrates widgets for header controls,
main controls, and action updates.
"""
